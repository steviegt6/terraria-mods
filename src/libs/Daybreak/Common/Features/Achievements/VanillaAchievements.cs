...
internal sealed class VanillaAchievements : ModSystem
{
    ...
    private sealed class VanillaAchievement : Achievement
    {
        ...
        public override AchievementKind Kind => new_kinds[key];
    ...
    private static readonly Dictionary<string, AchievementKind> new_kinds = [];
    ...
    public override void Load()
    {
        ...
        new_kinds["TIMBER"] = AchievementKind.PerPlayer;
        new_kinds["NO_HOBO"] = AchievementKind.PerWorld;
        new_kinds["OBTAIN_HAMMER"] = AchievementKind.PerPlayer;
        new_kinds["HEART_BREAKER"] = AchievementKind.PerPlayer;
        new_kinds["OOO_SHINY"] = AchievementKind.PerPlayer;
        new_kinds["HEAVY_METAL"] = AchievementKind.PerPlayer;
        new_kinds["I_AM_LOOT"] = AchievementKind.PerPlayer;
        new_kinds["STAR_POWER"] = AchievementKind.PerPlayer;
        new_kinds["HOLD_ON_TIGHT"] = AchievementKind.Persistent;
        new_kinds["EYE_ON_YOU"] = AchievementKind.PerWorld;
        new_kinds["SMASHING_POPPET"] = AchievementKind.PerWorld;
        new_kinds["WORM_FODDER"] = AchievementKind.PerWorld;
        new_kinds["MASTERMIND"] = AchievementKind.PerWorld;
        new_kinds["WHERES_MY_HONEY"] = AchievementKind.PerWorld;
        new_kinds["STING_OPERATION"] = AchievementKind.PerWorld;
        new_kinds["BONED"] = AchievementKind.PerWorld;
        new_kinds["DUNGEON_HEIST"] = AchievementKind.PerPlayer;
        new_kinds["ITS_GETTING_HOT_IN_HERE"] = AchievementKind.PerPlayer;
        new_kinds["MINER_FOR_FIRE"] = AchievementKind.PerPlayer;
        new_kinds["STILL_HUNGRY"] = AchievementKind.PerWorld;
        new_kinds["ITS_HARD"] = AchievementKind.PerWorld;
        new_kinds["BEGONE_EVIL"] = AchievementKind.PerPlayer;
        new_kinds["EXTRA_SHINY"] = AchievementKind.PerPlayer;
        new_kinds["HEAD_IN_THE_CLOUDS"] = AchievementKind.Persistent;
        new_kinds["LIKE_A_BOSS"] = AchievementKind.PerPlayer;
        new_kinds["BUCKETS_OF_BOLTS"] = AchievementKind.PerPlayer;
        new_kinds["DRAX_ATTAX"] = AchievementKind.PerPlayer;
        new_kinds["PHOTOSYNTHESIS"] = AchievementKind.PerPlayer;
        new_kinds["GET_A_LIFE"] = AchievementKind.PerPlayer;
        new_kinds["THE_GREAT_SOUTHERN_PLANTKILL"] = AchievementKind.PerWorld;
        new_kinds["TEMPLE_RAIDER"] = AchievementKind.PerWorld;
        new_kinds["LIHZAHRDIAN_IDOL"] = AchievementKind.PerWorld;
        new_kinds["ROBBING_THE_GRAVE"] = AchievementKind.PerPlayer;
        new_kinds["BIG_BOOTY"] = AchievementKind.PerPlayer;
        new_kinds["FISH_OUT_OF_WATER"] = AchievementKind.PerWorld;
        new_kinds["OBSESSIVE_DEVOTION"] = AchievementKind.PerWorld;
        new_kinds["STAR_DESTROYER"] = AchievementKind.PerWorld;
        new_kinds["CHAMPION_OF_TERRARIA"] = AchievementKind.PerPlayer;
        new_kinds["BLOODBATH"] = AchievementKind.PerWorld;
        new_kinds["GOBLIN_PUNTER"] = AchievementKind.PerWorld;
        new_kinds["KILL_THE_SUN"] = AchievementKind.PerWorld;
        new_kinds["WALK_THE_PLANK"] = AchievementKind.PerWorld;
        new_kinds["DO_YOU_WANT_TO_SLAY_A_SNOWMAN"] = AchievementKind.PerWorld;
        new_kinds["TIN_FOIL_HATTER"] = AchievementKind.PerWorld;
        new_kinds["BALEFUL_HARVEST"] = AchievementKind.PerWorld;
        new_kinds["ICE_SCREAM"] = AchievementKind.PerWorld;
        new_kinds["SLIPPERY_SHINOBI"] = AchievementKind.PerWorld;
        new_kinds["STICKY_SITUATION"] = AchievementKind.PerWorld;
        new_kinds["REAL_ESTATE_AGENT"] = AchievementKind.Persistent;
        new_kinds["NOT_THE_BEES"] = AchievementKind.Persistent;
        new_kinds["JEEPERS_CREEPERS"] = AchievementKind.PerPlayer;
        new_kinds["FUNKYTOWN"] = AchievementKind.PerPlayer;
        new_kinds["INTO_ORBIT"] = AchievementKind.Persistent;
        new_kinds["ROCK_BOTTOM"] = AchievementKind.Persistent;
        new_kinds["MECHA_MAYHEM"] = AchievementKind.Persistent;
        new_kinds["GELATIN_WORLD_TOUR"] = AchievementKind.Persistent;
        new_kinds["FASHION_STATEMENT"] = AchievementKind.Persistent;
        new_kinds["VEHICULAR_MANSLAUGHTER"] = AchievementKind.Persistent;
        new_kinds["BULLDOZER"] = AchievementKind.Persistent;
        new_kinds["THERE_ARE_SOME_WHO_CALL_HIM"] = AchievementKind.Persistent;
        new_kinds["DECEIVER_OF_FOOLS"] = AchievementKind.Persistent;
        new_kinds["SWORD_OF_THE_HERO"] = AchievementKind.Persistent;
        new_kinds["LUCKY_BREAK"] = AchievementKind.Persistent;
        new_kinds["THROWING_LINES"] = AchievementKind.Persistent;
        new_kinds["DYE_HARD"] = AchievementKind.Persistent;
        new_kinds["FREQUENT_FLYER"] = AchievementKind.Persistent;
        new_kinds["THE_CAVALRY"] = AchievementKind.Persistent;
        new_kinds["COMPLETELY_AWESOME"] = AchievementKind.Persistent;
        new_kinds["TIL_DEATH"] = AchievementKind.Persistent;
        new_kinds["ARCHAEOLOGIST"] = AchievementKind.Persistent;
        new_kinds["PRETTY_IN_PINK"] = AchievementKind.Persistent;
        new_kinds["RAINBOWS_AND_UNICORNS"] = AchievementKind.Persistent;
        new_kinds["YOU_AND_WHAT_ARMY"] = AchievementKind.Persistent;
        new_kinds["PRISMANCER"] = AchievementKind.Persistent;
        new_kinds["IT_CAN_TALK"] = AchievementKind.PerWorld;
        new_kinds["WATCH_YOUR_STEP"] = AchievementKind.Persistent;
        new_kinds["MARATHON_MEDALIST"] = AchievementKind.Persistent;
        new_kinds["GLORIOUS_GOLDEN_POLE"] = AchievementKind.Persistent;
        new_kinds["SERVANT_IN_TRAINING"] = AchievementKind.Persistent;
        new_kinds["GOOD_LITTLE_SLAVE"] = AchievementKind.Persistent;
        new_kinds["TROUT_MONKEY"] = AchievementKind.Persistent;
        new_kinds["FAST_AND_FISHIOUS"] = AchievementKind.Persistent;
        new_kinds["SUPREME_HELPER_MINION"] = AchievementKind.Persistent;
        new_kinds["TOPPED_OFF"] = AchievementKind.PerPlayer;
        new_kinds["SLAYER_OF_WORLDS"] = AchievementKind.Persistent;
        new_kinds["YOU_CAN_DO_IT"] = AchievementKind.PerPlayer;
        new_kinds["SICK_THROW"] = num++;
        new_kinds["MATCHING_ATTIRE"] = num++;
        new_kinds["BENCHED"] = num++;
        new_kinds["DEFEAT_QUEEN_SLIME"] = num++;
        new_kinds["DEFEAT_EMPRESS_OF_LIGHT"] = num++;
        new_kinds["GET_ZENITH"] = num++;
        new_kinds["FIND_A_FAIRY"] = num++;
        new_kinds["DEFEAT_DREADNAUTILUS"] = num++;
        new_kinds["DEFEAT_OLD_ONES_ARMY_TIER3"] = num++;
        new_kinds["FLY_A_KITE_ON_A_WINDY_DAY"] = num++;
        new_kinds["TURN_GNOME_TO_STATUE"] = num++;
        new_kinds["TALK_TO_NPC_AT_MAX_HAPPINESS"] = num++;
        new_kinds["GET_TERRASPARK_BOOTS"] = num++;
        new_kinds["THROW_A_PARTY"] = num++;
        new_kinds["PET_THE_PET"] = num++;
        new_kinds["GO_LAVA_FISHING"] = num++;
        new_kinds["FOUND_GRAVEYARD"] = num++;
        new_kinds["DIE_TO_DEAD_MANS_CHEST"] = num++;
        new_kinds["DEFEAT_DEERCLOPS"] = num++;
        new_kinds["GET_GOLDEN_DELIGHT"] = num++;
        new_kinds["DRINK_BOTTLED_WATER_WHILE_DROWNING"] = num++;
        new_kinds["GET_CELL_PHONE"] = num++;
        new_kinds["GET_ANKH_SHIELD"] = num++;
        new_kinds["GAIN_TORCH_GODS_FAVOR"] = num++;
        new_kinds["PLAY_ON_A_SPECIAL_SEED"] = num++;
        new_kinds["ALL_TOWN_SLIMES"] = num++;
        new_kinds["TRANSMUTE_ITEM"] = num++;
        new_kinds["PURIFY_ENTIRE_WORLD"] = num++;
        new_kinds["TO_INFINITY_AND_BEYOND"] = num++;
