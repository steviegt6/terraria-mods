...
internal partial class NetworkOverrideSystem
{
    ...
    )
    {
        ...
        var num = 0;
        num = start + 1;
        var interactingPlayer = messageType = self.readBuffer[start];
        ...
        switch (b)
        {
            ...
            case 3:
                if (Main.netMode == 1)
                {
                    ...
                    var value5 = self.reader.ReadBoolean();
                    ...
                    var player12 = Main.player[num142];
                    ...
                    for (var num143 = 0; num143 < 59; num143++)
                    {
            ...
            case 4:
            {
                ...
                var player14 = Main.player[num211];
                ...
                {
                    for (var num212 = 0; num212 < 255; num212++)
                    {
            ...
            case 5:
            {
                ...
                var player17 = Main.player[num258];
                lock (player17)
                {
                    ...
                    var num261 = 0;
                    var flag16 = false;
                    var clientPlayer = Main.clientPlayer;
                    ...
                    {
                        var type17 = array3[num261].type;
                        var stack8 = array3[num261].stack;
                    ...
                    var canRelay = PlayerItemSlotID.CanRelay;
            ...
            case 7:
                if (Main.netMode == 1)
                {
                    ...
                    for (var num194 = 0; num194 < 3; num194++)
                    {
                        Main.treeX[num194] = self.reader.ReadInt32();
                    }

                    for (var num195 = 0; num195 < 4; num195++)
                    {
                        Main.treeStyle[num195] = self.reader.ReadByte();
                    }

                    for (var num196 = 0; num196 < 3; num196++)
                    {
                        Main.caveBackX[num196] = self.reader.ReadInt32();
                    }

                    for (var num197 = 0; num197 < 4; num197++)
                    {
            ...
            case 8:
            {
                ...
                NetMessage.TrySendData(7, self.whoAmI);
                var num70 = self.reader.ReadInt32();
                var num71 = self.reader.ReadInt32();
                var flag3 = true;
                if (num70 == -1 || num71 == -1)
                {
                    flag3 = false;
                ...
                var num72 = Netplay.GetSectionX(Main.spawnTileX) - 2;
                var num73 = Netplay.GetSectionY(Main.spawnTileY) - 1;
                var num74 = num72 + 5;
                var num75 = num73 + 3;
                if (num72 < 0)
                {
                ...
                var num76 = (num74 - num72) * (num75 - num73);
                var list = new List<Point>();
                for (var num77 = num72; num77 < num74; num77++)
                {
                    for (var num78 = num73; num78 < num75; num78++)
                    {
                ...
                if (flag3)
                {
                    ...
                    for (var num81 = num70; num81 <= num79; num81++)
                    {
                        for (var num82 = num71; num82 <= num80; num82++)
                        {
                ...
                for (var num83 = num72; num83 < num74; num83++)
                {
                    for (var num84 = num73; num84 < num75; num84++)
                    {
                ...
                if (flag3)
                {
                    for (var num85 = num70; num85 <= num79; num85++)
                    {
                        for (var num86 = num71; num86 <= num80; num86++)
                        {
                ...
                for (var num89 = 0; num89 < 200; num89++)
                {
                ...
                for (var num90 = 0; num90 < 1000; num90++)
                {
                ...
                for (var num91 = 0; num91 < NPCID.Count /*NPCLoader.NPCCount*/; num91++)
                {
            ...
            case 9:
                if (Main.netMode == 1)
                {
                    ...
                    var serverSpecialFlags = Netplay.Connection.ServerSpecialFlags;
            ...
            case 12:
            {
                ...
                var playerSpawnContext = (PlayerSpawnContext)self.reader.ReadByte();
                ...
                if (Netplay.Clients[self.whoAmI].State == 3)
                {
                    ...
                    var flag4 = NetMessage.DoesPlayerSlotCountAsAHost(self.whoAmI);
                    ...
                    NetMessage.TrySendData(12, -1, self.whoAmI, null, self.whoAmI, (byte)playerSpawnContext);
            ...
            case 13:
            {
                ...
                if (num138 != Main.myPlayer || Main.ServerSideCharacter)
                {
                    ...
                    var player10 = Main.player[num138];
            ...
            case 14:
            {
                ...
                var active = Main.player[num253].active;
                if (num254 == 1)
                {
            ...
            case 20:
            {
                ...
                var b13 = self.reader.ReadByte();
                if (!WorldGen.InWorld(num228, num229, 3))
                {
                    break;
                }

                var type12 = TileChangeType.None;
                ...
                BitsByte bitsByte30 = 0;
                var tile4 = default(Tile);
                for (var num232 = num228; num232 < num228 + num230; num232++)
                {
                    for (var num233 = num229; num233 < num229 + num231; num233++)
                    {
                ...
                if (Main.netMode == 2)
                {
                    NetMessage.TrySendData(b, -1, self.whoAmI, null, num228, num229, num230, num231, b13);
                }
            ...
            case 148:
            {
                ...
                var position3 = self.reader.ReadVector2();
                var velocity3 = self.reader.ReadVector2();
                ...
                var shimmered = false;
                var shimmerTime = 0f;
                var timeLeftInWhichTheItemCannotBeTakenByEnemies = 0;
                if (b == 145)
                {
                ...
                if (Main.netMode == 1)
                {
                    ...
                    var num108 = num105;
                    var item2 = Main.item[num108];
                    var itemSyncPersistentStats = default(ItemSyncPersistentStats);
                    itemSyncPersistentStats.CopyFrom(item2);
                    var newAndShiny = (item2.newAndShiny || item2.netID != num107) && ItemSlot.Options.HighlightNewItems && (num107 < 0 || !ItemID.Sets.NeverAppearsAsNewInInventory[num107]);
            ...
            case 23:
            {
                ...
                var vector5 = self.reader.ReadVector2();
                var velocity5 = self.reader.ReadVector2();
                ...
                var array2 = self.ReUseTemporaryNPCAI();
                for (var num157 = 0; num157 < NPC.maxAI; num157++)
                {
                ...
                for (var num161 = 0; num161 < NPC.maxAI; num161++)
                {
            ...
            case 27:
            {
                ...
                var position = self.reader.ReadVector2();
                var velocity2 = self.reader.ReadVector2();
                ...
                var array = self.ReUseTemporaryProjectileAI();
                array[0] = bitsByte2[0] ? self.reader.ReadSingle() : 0f;
                array[1] = bitsByte2[1] ? self.reader.ReadSingle() : 0f;
                var bannerIdToRespondTo = bitsByte2[3] ? self.reader.ReadUInt16() : 0;
                var damage2 = bitsByte2[4] ? self.reader.ReadInt16() : 0;
                var knockBack2 = bitsByte2[5] ? self.reader.ReadSingle() : 0f;
                var originalDamage = bitsByte2[6] ? self.reader.ReadInt16() : 0;
                var num37 = bitsByte2[7] ? self.reader.ReadInt16() : -1;
                if (num37 >= 1000)
                {
                    num37 = -1;
                }
                ...
                if (num38 == 1000)
                {
                    for (var num39 = 0; num39 < 1000; num39++)
                    {
                ...
                var projectile = Main.projectile[num38];
                ...
                for (var num40 = 0; num40 < Projectile.maxAI; num40++)
                {
            ...
            case 28:
            {
                ...
                var num192 = self.reader.ReadSingle();
                var num193 = self.reader.ReadByte() - 1;
                var b10 = self.reader.ReadByte();
                if (Main.netMode == 2)
                {
                    if (num191 < 0)
                    {
            ...
            case 29:
            {
                ...
                for (var num100 = 0; num100 < 1000; num100++)
                {
            ...
            case 31:
            {
                ...
                var num221 = Chest.FindChest(num219, num220);
                if (num221 > -1 && Chest.UsingChest(num221) == -1)
                {
                    for (var num222 = 0; num222 < 40; num222++)
                    {
            ...
            case 33:
            {
                ...
                else
                {
                    if (num5 != 0)
                    {
                        var chest = Main.player[self.whoAmI].chest;
                        var chest2 = Main.chest[chest];
                        chest2.name = name;
            ...
            case 34:
            {
                ...
                if (Main.netMode == 2)
                {
                    ...
                    switch (b12)
                    {
                        case 0:
                        {
                            var num209 = WorldGen.PlaceChest(num203, num204, 21, notNearOtherChests: false, num205);
                            if (num209 == -1)
                            {
                                NetMessage.TrySendData(34, self.whoAmI, -1, null, b12, num203, num204, num205, num209);
                                Item.NewItem(new EntitySource_TileBreak(num203, num204), num203 * 16, num204 * 16, 32, 32, Chest.chestItemSpawn[num205], noBroadcast: true);
                            }
                            else
                            {
                        ...
                        case 1:
                            ...
                            {
                                var tile = Main.tile[num203, num204];
                                if (tile.frameX % 36 != 0)
                                {
                                    num203--;
                                }
                                ...
                                var number = Chest.FindChest(num203, num204);
                                WorldGen.KillTile(num203, num204);
                                if (!tile.active())
                                {
                                    NetMessage.TrySendData(34, -1, -1, null, b12, num203, num204, 0f, number);
                        ...
                        default:
                            switch (b12)
                            {
                                case 2:
                                {
                                    var num207 = WorldGen.PlaceChest(num203, num204, 88, notNearOtherChests: false, num205);
                                    if (num207 == -1)
                                    {
                                        NetMessage.TrySendData(34, self.whoAmI, -1, null, b12, num203, num204, num205, num207);
                                        Item.NewItem(new EntitySource_TileBreak(num203, num204), num203 * 16, num204 * 16, 32, 32, Chest.dresserItemSpawn[num205], noBroadcast: true);
                                    }
                                    else
                                    {
                                ...
                                case 3:
                                    ...
                                    {
                                        var tile2 = Main.tile[num203, num204];
                                        num203 -= tile2.frameX % 54 / 18;
                                        if (tile2.frameY % 36 != 0)
                                        {
                                            num204--;
                                        ...
                                        var number2 = Chest.FindChest(num203, num204);
                                        WorldGen.KillTile(num203, num204);
                                        if (!tile2.active())
                                        {
                                            NetMessage.TrySendData(34, -1, -1, null, b12, num203, num204, 0f, number2);
                                ...
                                default:
                                    switch (b12)
                                    {
                                        case 4:
                                        {
                                            var num208 = WorldGen.PlaceChest(num203, num204, 467, notNearOtherChests: false, num205);
                                            if (num208 == -1)
                                            {
                                                NetMessage.TrySendData(34, self.whoAmI, -1, null, b12, num203, num204, num205, num208);
                                                Item.NewItem(new EntitySource_TileBreak(num203, num204), num203 * 16, num204 * 16, 32, 32, Chest.chestItemSpawn2[num205], noBroadcast: true);
                                            }
                                            else
                                            {
                                                NetMessage.TrySendData(34, -1, -1, null, b12, num203, num204, num205, num208);
                                        ...
                                        case 5:
                                            if (Main.tile[num203, num204].type == 467)
                                            {
                                                var tile3 = Main.tile[num203, num204];
                                                if (tile3.frameX % 36 != 0)
                                                {
                                                    num203--;
                                                }
                                                ...
                                                var number3 = Chest.FindChest(num203, num204);
                                                WorldGen.KillTile(num203, num204);
                                                if (!tile3.active())
                                                {
                                                    NetMessage.TrySendData(34, -1, -1, null, b12, num203, num204, 0f, number3);
            ...
            case 36:
            {
                ...
                var player7 = Main.player[num101];
                var flag5 = player7.zone5[0];
            ...
            case 41:
            {
                ...
                var player15 = Main.player[num226];
                var itemRotation = self.reader.ReadSingle();
            ...
            case 45:
            {
                ...
                var player8 = Main.player[num117];
                var team = player8.team;
                player8.team = num118;
                var color = Main.teamColor[num118];
                if (Main.netMode != 2)
                {
                    break;
                }
                ...
                var localizedText = Lang.mp[13 + num118];
                if (num118 == 5)
                {
                    localizedText = Lang.mp[22];
                }

                for (var num119 = 0; num119 < 255; num119++)
                {
            ...
            case 46:
                if (Main.netMode == 2)
                {
                    var i3 = self.reader.ReadInt16();
                    int j3 = self.reader.ReadInt16();
                    var num111 = Sign.ReadSign(i3, j3);
                    if (num111 >= 0)
                    {
            ...
            case 47:
            {
                ...
                var text = self.reader.ReadString();
            ...
            case 48:
            {
                ...
                var b15 = self.reader.ReadByte();
                var liquidType = self.reader.ReadByte();
                if (Main.netMode == 2 && Netplay.SpamCheck)
                {
                    var num239 = self.whoAmI;
                    var num240 = (int)(Main.player[num239].position.X + Main.player[num239].width / 2);
                    var num262 = (int)(Main.player[num239].position.Y + Main.player[num239].height / 2);
                    var num242 = 10;
                    var num243 = num240 - num242;
                    var num244 = num240 + num242;
                    var num245 = num262 - num242;
                    var num246 = num262 + num242;
            ...
            case 50:
            {
                ...
                var player13 = Main.player[num180];
                for (var num181 = 0; num181 < Player.maxBuffs; num181++)
                {
            ...
            case 51:
            {
                var b8 = self.reader.ReadByte();
                var b9 = self.reader.ReadByte();
                switch (b9)
                {
                    case 1:
                    ...
                    case 2:
                        if (Main.netMode == 2)
                        {
                            NetMessage.TrySendData(51, -1, self.whoAmI, null, b8, b9);
                        }
                        else
                        {
            ...
            case 54:
                if (Main.netMode == 1)
                {
                    ...
                    var nPC4 = Main.npc[num109];
                    for (var num110 = 0; num110 < NPC.maxBuffs; num110++)
                    {
            ...
            case 55:
            {
                ...
                var num50 = self.reader.ReadInt32();
            ...
            case 56:
            {
                ...
                if (num27 >= 0 && num27 < 200)
                {
                    if (Main.netMode == 1)
                    {
                        var givenName = self.reader.ReadString();
                        Main.npc[num27].GivenName = givenName;
                        var townNpcVariationIndex = self.reader.ReadInt32();
            ...
            case 58:
            {
                ...
                var num257 = self.reader.ReadSingle();
                if (Main.netMode == 2)
                {
                ...
                var player16 = Main.player[num256];
                var type14 = player16.inventory[player16.selectedItem].type;
                switch (type14)
                {
                    case 4057:
                    case 4372:
            ...
            case 60:
            {
                ...
                var nPC7 = Main.npc[num250];
                var isLikeATownNPC = nPC7.isLikeATownNPC;
                if (Main.netMode == 1)
                {
                    nPC7.homeless = b16 == 1;
            ...
            case 63:
            {
                ...
                var b5 = self.reader.ReadByte();
                var b6 = self.reader.ReadByte();
                if (b6 == 0)
                {
                ...
                if (Main.netMode == 2)
                {
                    NetMessage.TrySendData(63, -1, self.whoAmI, null, num144, num145, b5, b6);
                }
            ...
            case 64:
            {
                ...
                var b3 = self.reader.ReadByte();
                var b4 = self.reader.ReadByte();
                if (b4 == 0)
                {
                ...
                if (Main.netMode == 2)
                {
                    NetMessage.TrySendData(64, -1, self.whoAmI, null, num131, num132, b3, b4);
                }
            ...
            case 65:
            {
                ...
                var vector = self.reader.ReadVector2();
                var num52 = 0;
                ...
                switch (num53)
                {
                    ...
                    case 2:
                    {
                        ...
                        var num55 = -1;
                        var num56 = 9999f;
                        for (var num57 = 0; num57 < 255; num57++)
                        {
                            if (Main.player[num57].active && num57 != self.whoAmI)
                            {
                                var vector2 = Main.player[num57].position - Main.player[self.whoAmI].position;
            ...
            case 71:
                if (Main.netMode == 2)
                {
                    var x15 = self.reader.ReadInt32();
                    var y13 = self.reader.ReadInt32();
                    int type11 = self.reader.ReadInt16();
                    var style3 = self.reader.ReadByte();
            ...
            case 72:
                if (Main.netMode == 1)
                {
                    for (var num210 = 0; num210 < 40; num210++)
                    {
            ...
            case 75:
                if (Main.netMode == 2)
                {
                    var name2 = Main.player[self.whoAmI].name;
            ...
            case 77:
            {
                var type18 = self.reader.ReadInt16();
                var tileType = self.reader.ReadUInt16();
                var x11 = self.reader.ReadInt16();
                var y11 = self.reader.ReadInt16();
            ...
            case 81:
                if (Main.netMode == 1)
                {
                    var x19 = (int)self.reader.ReadSingle();
                    var y7 = (int)self.reader.ReadSingle();
            ...
            case 119:
                if (Main.netMode == 1)
                {
                    var x18 = (int)self.reader.ReadSingle();
                    var y8 = (int)self.reader.ReadSingle();
            ...
            case 83:
                if (Main.netMode == 1)
                {
                    ...
                    var num104 = self.reader.ReadInt32();
                    if (num103 >= 0)
                    {
            ...
            case 84:
            {
                ...
                var stealth = self.reader.ReadSingle();
            ...
            case 86:
            {
                ...
                var num67 = self.reader.ReadInt32();
                ...
                {
                    var tileEntity = TileEntity.Read(self.reader, networkSend: true /*, lightSend: true*/);
                    tileEntity.ID = num67;
            ...
            case 91:
            {
                ...
                var num185 = self.reader.ReadInt32();
                ...
                var worldUIAnchor = EmoteBubble.DeserializeNetAnchor(num186, num187);
                if (num186 == 1)
                {
            ...
            case 92:
            {
                ...
                var num173 = self.reader.ReadInt32();
                var num174 = self.reader.ReadSingle();
                var num175 = self.reader.ReadSingle();
            ...
            case 95:
            {
                var num168 = self.reader.ReadUInt16();
                ...
                for (var num170 = 0; num170 < 1000; num170++)
                {
                    if (Main.projectile[num170].owner == num168 && Main.projectile[num170].active && Main.projectile[num170].type == 602 && Main.projectile[num170].ai[1] == num169)
                    {
                        Main.projectile[num170].Kill();
                        NetMessage.TrySendData(29, -1, -1, null, Main.projectile[num170].identity, num168);
                        break;
                    }
                }
            ...
            case 96:
            {
                ...
                var obj5 = Main.player[num162];
                int num163 = self.reader.ReadInt16();
                var newPos2 = self.reader.ReadVector2();
                var velocity6 = self.reader.ReadVector2();
                var lastPortalColorIndex2 = num163 + ((num163 % 2 == 0) ? 1 : -1);
            ...
            case 100:
            {
                ...
                var obj4 = Main.npc[num129];
                int num130 = self.reader.ReadInt16();
                var newPos = self.reader.ReadVector2();
                var velocity4 = self.reader.ReadVector2();
                var lastPortalColorIndex = num130 + ((num130 % 2 == 0) ? 1 : -1);
            ...
            case 102:
            {
                ...
                var num59 = self.reader.ReadUInt16();
                var other = self.reader.ReadVector2();
                if (Main.netMode == 2)
                {
                    num58 = self.whoAmI;
                    NetMessage.TrySendData(102, -1, -1, null, num58, num59, other.X, other.Y);
                    break;
                }

                var player4 = Main.player[num58];
                for (var num60 = 0; num60 < 255; num60++)
                {
                    var player5 = Main.player[num60];
                    if (!player5.active || player5.dead || (player4.team != 0 && player4.team != player5.team) || !(player5.Distance(other) < 700f))
                    {
                        continue;
                    }

                    var value2 = player4.Center - player5.Center;
                    var vector3 = Vector2.Normalize(value2);
                    if (!vector3.HasNaNs())
                    {
                        var type4 = 90;
                        var num61 = 0f;
                        var num62 = (float)Math.PI / 15f;
                        var spinningpoint = new Vector2(0f, -8f);
                        var vector4 = new Vector2(-3f);
                        var num63 = 0f;
                        var num64 = 0.005f;
                        switch (num59)
                        {
                        ...
                        for (var num65 = 0; num65 < value2.Length() / 6f; num65++)
                        {
                            var position4 = player5.Center + 6f * num65 * vector3 + spinningpoint.RotatedBy(num61) + vector4;
                            num61 += num62;
                            var num66 = Dust.NewDust(position4, 6, 6, type4, 0f, 0f, 100, default(Color), 1.5f);
            ...
            case 104:
                if (Main.netMode == 1 && Main.npcShop > 0)
                {
                    ...
                    var value = self.reader.ReadInt32();
            ...
            case 105:
                if (Main.netMode != 1)
                {
                    var i2 = self.reader.ReadInt16();
                    int j2 = self.reader.ReadInt16();
                    var on = self.reader.ReadBoolean();
            ...
            case 107:
                if (Main.netMode == 1)
                {
                    var c = self.reader.ReadRGB();
                    var text3 = NetworkText.Deserialize(self.reader).ToString();
            ...
            case 108:
                if (Main.netMode == 1)
                {
                    ...
                    var knockBack = self.reader.ReadSingle();
            ...
            case 109:
                if (Main.netMode == 2)
                {
                    var x16 = self.reader.ReadInt16();
                    int y2 = self.reader.ReadInt16();
                    int x3 = self.reader.ReadInt16();
                    int y3 = self.reader.ReadInt16();
                    var toolMode3 = self.reader.ReadByte();
                    var num29 = self.whoAmI;
            ...
            case 112:
            {
                ...
                var num14 = self.reader.ReadInt32();
                var num15 = self.reader.ReadInt32();
            ...
            case 117:
            {
                ...
                if (true /*!directHurt*/)
                {
                    var playerDeathReason2 = PlayerDeathReason.FromReader(self.reader);
                    int damage3 = self.reader.ReadInt16();
                    var num235 = self.reader.ReadByte() - 1;
                    BitsByte bitsByte31 = self.reader.ReadByte();
                    var flag15 = bitsByte31[0];
                    var pvp2 = bitsByte31[1];
            ...
            case 118:
            {
                ...
                var playerDeathReason = PlayerDeathReason.FromReader(self.reader);
                int num224 = self.reader.ReadInt16();
                var num225 = self.reader.ReadByte() - 1;
                var pvp = ((BitsByte)self.reader.ReadByte())[0];
            ...
            case 121:
            {
                ...
                var num183 = self.reader.ReadInt32();
            ...
            case 122:
            {
                var num153 = self.reader.ReadInt32();
            ...
            case 124:
            {
                ...
                var num134 = self.reader.ReadInt32();
            ...
            case 127:
            {
                var markerUniqueID = self.reader.ReadInt32();
                if (Main.netMode == 1)
                {
            ...
            case 130:
            {
                ...
                var type5 = nPC8.type;
                var netID = nPC8.netID;
                var num96 = NPC.NewNPC(new EntitySource_FishedOut(Main.player[self.whoAmI]), num93, num94, num95);
                if (netID != type5)
                {
            ...
            case 131:
                if (Main.netMode == 1)
                {
                    ...
                    {
                        var time = self.reader.ReadInt32();
            ...
            case 132:
                if (Main.netMode == 1)
                {
                    var point = self.reader.ReadVector2().ToPoint();
                    var key = self.reader.ReadUInt16();
                    var legacySoundStyle = SoundID.SoundByIndex[key];
            ...
            case 134:
            {
                ...
                var ladyBugLuckTimeLeft = self.reader.ReadInt32();
                var torchLuck = self.reader.ReadSingle();
                var luckPotion = self.reader.ReadByte();
                var hasGardenGnomeNearby = self.reader.ReadBoolean();
                var equipmentBasedLuckBonus = self.reader.ReadSingle();
                var coinLuck = self.reader.ReadSingle();
                if (Main.netMode == 2)
                {
                    num41 = self.whoAmI;
                }

                var obj3 = Main.player[num41];
            ...
            case 139:
                if (Main.netMode != 2)
                {
                    ...
                    var flag = self.reader.ReadBoolean();
            ...
            case 140:
            {
                ...
                var num25 = self.reader.ReadInt32();
                switch (num24)
                {
                    case 0:
                        if (Main.netMode == 1)
            ...
            case 141:
            {
                var messageSource = (LucyAxeMessage.MessageSource)self.reader.ReadByte();
                var b2 = self.reader.ReadByte();
                var velocity = self.reader.ReadVector2();
                var num21 = self.reader.ReadInt32();
                var num22 = self.reader.ReadInt32();
                if (Main.netMode == 2)
                {
                    NetMessage.SendData(141, -1, self.whoAmI, null, (int)messageSource, b2, velocity.X, velocity.Y, num21, num22);
                }
                else
                {
            ...
            case 146:
                switch (self.reader.ReadByte())
                {
                    ...
                    case 1:
                    {
                        var coinPosition = self.reader.ReadVector2();
                        var coinAmount = self.reader.ReadInt32();
                    ...
                    case 2:
                    {
                        var num12 = self.reader.ReadInt32();
            ...
            case 253:
            {
                var keepAlive = "Keep Alive During Mod Reload";
                ModNet.Log(self.whoAmI, keepAlive);
                var client = Netplay.Clients[self.whoAmI];
            ...
            case 24:
                ...
                var player9 = Main.player[num121];
